    ...
    public static function downloadPDF(Request $request)
    {
        ...
        foreach ($teams as $team) {
            if (count($latest_version_team) == 0 || in_array($team->id, $latest_version_team)) {
                ...
                if ($leader_list_count > 0) {
                    ...
                    $leader_list_string .= "<td colspan='2' class='table_detail_key thin_bottom' style='{$multirow_border_bottom}'><span style='float: left;'>Leader :</span><span style='float: right;'>{$leader_list_count}</span></td>";
                ...
                if ($team_vehicle_list_count > 0) {
                    ...
                    $team_vehicle_list_string .= "<td colspan='2' class='table_detail_key' style='{$multirow_border_bottom}'><span style='float: left;'>Vehicle :</span><span style='float: right;'>{$team_vehicle_list_count}</span></td>";
        ...
        if (count($latest_version_team) == 0 || in_array('AL', $latest_version_team)) {
            ...
            if ($annual_leave_list_count > 0) {
                ...
                $annual_leave_list_string .= "<td class='table_detail_key' style='{$multirow_border_bottom}'><span style='float: left;'>Annual Leave :</span><span style='float: right;'>{$annual_leave_list_count}</span></td>";
        ...
        if (count($latest_version_team) == 0 || in_array('MC', $latest_version_team)) {
            ...
            if ($mc_list_count > 0) {
                ...
                $mc_list_string .= "<td class='table_detail_key' style='{$multirow_border_bottom}'><span style='float: left;'>Medical Leave :</span> <span style='float: right;'>{$mc_list_count}</span></td>";
        ...
        if (count($latest_version_team) == 0 || in_array('EL', $latest_version_team)) {
            ...
            if ($emergency_leave_list_count > 0) {
                ...
                $emergency_leave_list_string .= "<td class='table_detail_key' style='{$multirow_border_bottom}'><span style='float: left;'>Emergency Leave :</span><span style='float: right;'>{$emergency_leave_list_count}</span></td>";
        ...
        if (count($latest_version_team) == 0 || in_array('HOL', $latest_version_team)) {
            ...
            if ($holiday_list_count > 0) {
                ...
                $holiday_list_string .= "<td class='table_detail_key' style='{$multirow_border_bottom}'><span style='float: left;'>Holiday :</span> <span style='float: right;'>{$holiday_list_count}</span></td>";
